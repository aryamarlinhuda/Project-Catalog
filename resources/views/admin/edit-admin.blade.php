@extends('sidebar')
@section('title','Edit Admin | Catalog App')
@section('admin','active')
@section('edit-admin')
<a href="{{ url('admin/list') }}" class="btn btn-info my-3">
...
<h1>Edit Admin</h1>
<hr>
<form action="{{ url('admin/edit/'.$data->id.'/process') }}" method="POST" class="col-md-8" enctype="multipart/form-data">
    @csrf
        <div class="mt-3 mb-4">
